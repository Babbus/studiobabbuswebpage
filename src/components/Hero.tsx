    ...
    <section className="pt-24 sm:pt-28 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 grid gap-8 sm:grid-cols-2 items-center relative z-10">
        <div className="space-y-5 animate-fade-in-up">
          <h1 className="text-3xl sm:text-5xl font-semibold tracking-tight bg-gradient-to-r from-white via-teal-100 to-white bg-clip-text text-transparent animate-gradient">
            {siteMeta.displayName} — {siteMeta.alias}
          </h1>
          <p className="text-base/7 sm:text-lg/8 opacity-80 max-w-[60ch] transition-opacity duration-300 hover:opacity-100">
            {siteMeta.tagline}
          </p>
          <div className="flex gap-3">
            <button
              className="group rounded-full border border-white/10 bg-teal-500/20 text-teal-200 hover:bg-teal-500/40 hover:border-teal-400/30 px-5 py-2 text-sm transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-teal-500/20"
            ...
            <a 
              href="#portfolio" 
              className="rounded-full border border-white/10 px-5 py-2 text-sm hover:bg-white/10 hover:border-white/20 transition-all duration-300 hover:scale-105"
            >
              See portfolio
            </a>
          </div>
        </div>
        <div className="group aspect-video rounded-2xl bg-gradient-to-br from-teal-900/40 via-teal-700/20 to-transparent border border-white/10 p-2 transition-all duration-500 hover:border-teal-400/30 hover:shadow-2xl hover:shadow-teal-500/10 animate-fade-in-up relative overflow-hidden" style={{ animationDelay: '0.3s' }}>
          {showVideo && featuredSrc ? (
            ...
            <div className="w-full h-full rounded-xl bg-black/40 grid place-items-center transition-all duration-300 group-hover:bg-black/60 relative overflow-hidden">
              {featuredThumb && (
              ...
              <button
                className="w-16 h-16 rounded-full bg-teal-400/90 text-black grid place-items-center shadow-lg hover:scale-110 hover:bg-teal-300 transition-all duration-300 hover:shadow-xl hover:shadow-teal-400/30 relative z-10"
