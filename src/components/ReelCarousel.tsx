  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between mb-6">
        <button
          className="group rounded-full border border-black/10 dark:border-white/10 px-4 py-2 text-sm disabled:opacity-40 hover:bg-teal-600/10 dark:hover:bg-teal-500/20 hover:border-teal-500/30 dark:hover:border-teal-400/30 hover:text-teal-800 dark:hover:text-teal-200 transition-all duration-300 hover:scale-105 disabled:hover:scale-100 disabled:hover:bg-transparent"
